 ...
 */
export interface Namespace extends NodeJS.EventEmitter {
    /**
...
export interface Adapter extends NodeJS.EventEmitter {
     ...
     */
    rooms: {
        [room: string]: { sockets: { [id: string]: boolean }; length: number };
    };
 ...
 */
export interface EngineSocket extends NodeJS.EventEmitter {
    /**
